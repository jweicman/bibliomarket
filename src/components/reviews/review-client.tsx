...
export function ReviewClient({ orderId }: { orderId: string }) {
    ...
    <>
      ...
      <main className="container-main py-10 max-w-lg">
        <div className="bg-white rounded-2xl border border-paper-200 p-8">
          ...
          <p className="text-ink-500 text-sm mb-6">Tu opinión ayuda a otros compradores.</p>
          {loading ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  ...
                  <textarea value={comment} onChange={(e) => setComment(e.target.value)}
                    ...
                    placeholder="Contá cómo fue el proceso..."
